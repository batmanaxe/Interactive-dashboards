...
hour = st.sidebar.slider("Hour of the day",min_value=1, max_value = 24)

modified_data = data[data['tweet_created'].dt.hour==hour]
if not st.sidebar.checkbox("Close",True,key='1'):
    st.markdown("### Tweets locations based  of the time of day")
...
word_sentiment = st.sidebar.radio('Display word cloud of what sentiment',('positive','neutral','negative'))
